...
export default class WebDav {
  ...
  constructor() {
    ...
    let remort_host: string;
    if (this.webdavConfig.port == "443") {
      remort_host = `${this.webdavConfig.host}`;
    } else {
      remort_host = `${this.webdavConfig.host}:${this.webdavConfig.port}`;
    }

    this.client = createClient(remort_host, {
